...
const makeStyles = (palette: ReturnType<typeof useLumen>["palette"]) => StyleSheet.create({
  ...
  brandDivider: { color: palette.accentText, fontSize: 19, fontWeight: "900" },
  ...
  eyebrow: { color: palette.accentText, fontSize: 10, fontWeight: "900", letterSpacing: 1.5, marginBottom: 12 },
  ...
  routeLabel: { color: palette.accentText, fontSize: 10, fontWeight: "900", letterSpacing: 1 },
  ...
  stepNumber: { color: palette.accentText, fontSize: 11, fontWeight: "900", letterSpacing: 0.9 },
  ...
  contactEyebrow: { color: palette.accentText, fontSize: 10, fontWeight: "900", letterSpacing: 1, marginBottom: 7 },
  ...
  helpLabel: { color: palette.accentText, fontSize: 10, fontWeight: "900", letterSpacing: 1, marginBottom: 7 },
