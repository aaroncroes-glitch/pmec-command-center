...
export type LeaveRequest = { id: string; type: "Vacation" | "Sick" | "Personal"; startDate: string; endDate: string; reason: string; status: "pending" | "approved" | "declined" };
...
export type EssState = { onboarded: boolean; sessionEmployeeId?: string; employee: DemoEmployee; attendance: AttendanceRecord[]; projects: WorkProject[]; leaveRequests: LeaveRequest[]; payslips: Payslip[]; events: PersonalEvent[]; activity: ActivityItem[] };
