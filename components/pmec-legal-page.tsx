...
const makeStyles = (palette: ReturnType<typeof useLumen>["palette"]) => StyleSheet.create({
  ...
  eyebrow: { color: palette.accentText, fontSize: 10, fontWeight: "900", letterSpacing: 1.4, marginBottom: 14 },
  ...
  number: { color: palette.accentText, fontSize: 11, fontWeight: "900", letterSpacing: 0.8, paddingTop: 3, width: 28 },
  sectionBody: { flex: 1 },
  ...
  contactLabel: { color: palette.accentText, fontSize: 10, fontWeight: "900", letterSpacing: 1, marginBottom: 8 },
